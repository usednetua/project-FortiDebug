...
class UtmIpsTab(BaseTab):
    ...
    def _build_ui(self):
        ...
        tip(self.filter_ip, "IP для diagnose ips filter set src/dst")
        ...
        tip(self.ips_filter_list, "Поточний IPS filter")
        ...
        tip(self.ips_filter_set, "diagnose ips filter set src/dst …")
        ...
        tip(self.ips_debug, "Дуже шумно — одразу stop block")
        ...
        tip(self.av_stats, "Antivirus engine stats")
        ...
        tip(self.urlfilter_debug, "diagnose debug application urlfilter -1")
