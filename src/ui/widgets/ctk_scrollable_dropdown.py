...
Author: Akash Bora
Vendored from https://github.com/Akascape/CTkScrollableDropdown (MIT)
'''
...
class CTkScrollableDropdown(customtkinter.CTkToplevel):
    ...
    def __init__(self, attach, x=None, y=None, button_color=None, height: int = 200, width: int = None,
                 ...
                 command=None, image_values=None, alpha: float = 0.97, frame_corner_radius=20, double_click=False,
    ...
    def _withdraw(self):
        if not self.winfo_exists():
            return
        if self.winfo_viewable() and self._hidden:
            self.withdraw()
